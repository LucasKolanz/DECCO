#This file is meant to check the dimensions of a specified file located in a specified path. At the moment, only works for CSV files
#and based on how they are laid out, doesn't make sense for the h5 files generated by this project.
