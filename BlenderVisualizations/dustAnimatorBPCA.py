...
path = '/mnt/be2a0173-321f-4b9d-b05a-addba547276f/kolanzl/SpaceLab_stable/SpaceLab/jobs/comparison_test2/N_100/T_1000/'
path = '/mnt/be2a0173-321f-4b9d-b05a-addba547276f/kolanzl/SpaceLab/jobs/comparison_test1/N_100/T_1000/'
...
simStart = 89
simEnd = 99
print(path + str(simStart) + filename + "simData.csv")
simData = np.loadtxt(path + str(simStart) + filename + "simData.csv",dtype=float,delimiter=',',skiprows = 1)
print(simData)
...
steps = len(simData)
print("steps: ",steps)
constants = np.genfromtxt(path + str(simStart) + filename + "constants.csv",dtype=float,delimiter=',')
...
#print(sphereSet)
for sim in range(simStart,simEnd):
    if frameNum > 1:        
