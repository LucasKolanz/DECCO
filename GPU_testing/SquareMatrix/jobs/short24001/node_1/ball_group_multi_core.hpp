...
void Ball_group::sim_one_step(const bool write_step)
{
    ...
    #pragma acc parallel loop gang num_gangs(108) num_workers(256) reduction(+:pe) present(this,accsq[0:num_particles*num_particles],aaccsq[0:num_particles*num_particles],m[0:num_particles],moi[0:num_particles],w[0:num_particles],vel[0:num_particles],pos[0:num_particles],R[0:num_particles],distances[0:num_pairs],num_pairs,num_particles,Ha,k_in,k_out,h_min,u_s,u_r,writeStep,world_rank,world_size)
