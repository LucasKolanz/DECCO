	...
	for attempt in attempts:
		for n in N:
			...
			for node in nodes:
				...
				os.system("cp /pscratch/sd/l/lpkolanz/DECCOmain/SpaceLab/GPU_testing/SquareMatrix/jobs/long24002/node_1/1199_2_R4e-05_v4e-01_cor0.63_mu0.1_rho2.25_k4e+00_Ha5e-12_dt5e-10_constants.csv {}.".format(job))
				os.system("cp /pscratch/sd/l/lpkolanz/DECCOmain/SpaceLab/GPU_testing/SquareMatrix/jobs/long24002/node_1/1199_2_R4e-05_v4e-01_cor0.63_mu0.1_rho2.25_k4e+00_Ha5e-12_dt5e-10_energy.csv {}.".format(job))
				os.system("cp /pscratch/sd/l/lpkolanz/DECCOmain/SpaceLab/GPU_testing/SquareMatrix/jobs/long24002/node_1/1199_2_R4e-05_v4e-01_cor0.63_mu0.1_rho2.25_k4e+00_Ha5e-12_dt5e-10_simData.csv {}.".format(job))
