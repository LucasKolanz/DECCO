		...
		for n in N:
			for Temp in Temps:
				...
				if os.path.exists(job+"timing.txt"):
					...
					input_json['projectileName'] = input_json['data_directory']+"jobs/const300/300_data.h5"
					input_json['targetName'] = input_json['data_directory']+"jobs/const300/300_data.h5"
					...
					sbatchfile += f"#SBATCH -J LarColl,a={attempt},n={n},t={Temp}\n"
					...
					# sbatchfile += 'module load gcc/12.4\n'
