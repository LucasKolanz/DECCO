	...
	for attempt in attempts:
		for n in N:
			for Temp in Temps:
				...
				input_json['random_folder_template'] = "/media/kolanzl/easystore/SpaceLab_data/jobsCosine/lognorm_relax{a}/N_100/T_1000/"
				...
				os.system(f"cp /media/kolanzl/easystore/SpaceLab_data/jobsCosine/lognorm_relax0/N_100/T_3/97_RELAXconstants.csv {job}100_constants.csv")
				os.system(f"cp /media/kolanzl/easystore/SpaceLab_data/jobsCosine/lognorm_relax0/N_100/T_3/97_RELAXsimData.csv {job}100_simData.csv")
				os.system(f"cp /media/kolanzl/easystore/SpaceLab_data/jobsCosine/lognorm_relax0/N_100/T_3/97_RELAXenergy.csv {job}100_energy.csv")
