		...
		for attempt in attempts:
			for eta in etas:
				...
				if os.path.exists(job+"timing.txt"):
					...
					input_json['projectileName'] = f"/home/kolanzl/novus/kolanzl/SpaceLab_data/jobs/reference_jobs/{job_set_name.split('_')[0]}_relax{rand_int(0,30)}/N_{ns[0]}/T_{'3'}/"
					input_json['targetName'] = f"/home/kolanzl/novus/kolanzl/SpaceLab_data/jobs/reference_jobs/{job_set_name.split('_')[0]}_relax{rand_int(0,30)}/N_{ns[1]}/T_{3}/"
