...
def main():
	...
	error4_folders = check_error(source_job,cfe.error4,N,Temps,attempts) #out of the errored jobs, which ones do not have error 4
	errorgen_folders = cfe.check_error(source_job,cfe.error_general,N,Temps,attempts) #out of the errored jobs, which ones do have error general
