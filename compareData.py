...
def main():
	...
	folder1 = "/global/homes/l/lpkolanz/DECCO/SpaceLab_data/jobs/masterComp0/N_10/T_3/"
	folder2 = "/global/homes/l/lpkolanz/DECCO/SpaceLab_data/jobs/masterComp1/N_10/T_3/"
	...
	for ind in [0]:#range(N):
		...
		if np.sum(different) == 0:
			...
			# print(energyData1[:20])
			# print(energyData2[:20])
